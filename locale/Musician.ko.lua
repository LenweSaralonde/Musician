...
msg.INSTRUMENT_NAMES["viola-da-gamba"] = "비올라 다 감바"
msg.INSTRUMENT_NAMES["harp"] = "셀틱 하프"
msg.INSTRUMENT_NAMES["male-voice"] = "남성 목소리 (테너)"
msg.INSTRUMENT_NAMES["female-voice"] = "여성 목소리 (소프라노)"
msg.INSTRUMENT_NAMES["trumpet"] = "트럼펫"
msg.INSTRUMENT_NAMES["sackbut"] = "Sackbut"
msg.INSTRUMENT_NAMES["war-horn"] = "전쟁 경적"
...
msg.INSTRUMENT_NAMES["distortion-guitar"] = "왜곡 기타"
msg.INSTRUMENT_NAMES["clean-guitar"] = "깨끗한 기타"
msg.INSTRUMENT_NAMES["bass-guitar"] = "베이스 기타"
msg.INSTRUMENT_NAMES["drumkit"] = "드럼 키트"
msg.INSTRUMENT_NAMES["war-drum"] = "전쟁 드럼"
msg.INSTRUMENT_NAMES["woodblock"] = "판목"
msg.INSTRUMENT_NAMES["tambourine-shake"] = "탬버린 (흔들림)"
