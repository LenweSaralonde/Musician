...
msg.OPTIONS_AUDIO_CHANNELS_TITLE = "音頻通道"
msg.OPTIONS_AUDIO_CHANNELS_HINT = "選擇更多音頻通道以增加 Musician 可以同時播放的最大音符數。"
msg.OPTIONS_AUDIO_CHANNELS_CHANNEL_POLYPHONY = "{channel} ({polyphony})"
msg.OPTIONS_AUDIO_CHANNELS_TOTAL_POLYPHONY = "最大復音總數：{polyphony}"
msg.OPTIONS_AUDIO_CHANNELS_AUTO_ADJUST_CONFIG = "選擇多個音頻通道時自動優化音頻設置。"
