...
msg.COMMAND_MUTE = "靜音所有音樂"
msg.COMMAND_UNMUTE = "取消靜音"
...
msg.OPTIONS_AUDIO_CHANNELS_TITLE = "聲音頻道"
msg.OPTIONS_AUDIO_CHANNELS_HINT = "選擇更多的聲音頻道以增加Musician同時能播放的音符數量。"
msg.OPTIONS_AUDIO_CHANNELS_CHANNEL_POLYPHONY = "{channel} ({polyphony})"
msg.OPTIONS_AUDIO_CHANNELS_TOTAL_POLYPHONY = "總最大復調數： {polyphony}"
msg.OPTIONS_AUDIO_CHANNELS_AUTO_ADJUST_CONFIG = "多個聲音頻道啟用時自動優化聲音設置。"
msg.OPTIONS_AUDIO_CACHE_SIZE_FOR_MUSICIAN = "建議用於Musician(%dMB)"
msg.OPTIONS_CATEGORY_SHORTCUTS = "快捷方式"
msg.OPTIONS_SHORTCUT_MINIMAP = "小地圖按鈕"
msg.OPTIONS_SHORTCUT_ADDON_MENU = "小地圖菜單"
msg.OPTIONS_QUICK_PRELOADING_TITLE = "快速預加載"
msg.OPTIONS_QUICK_PRELOADING_TEXT = "在冷啟動時啟用儀器快速預加載。"
msg.OPTIONS_CATEGORY_NAMEPLATES = "姓名版和動作"
msg.OPTIONS_CATEGORY_NAMEPLATES_SUB_TEXT = "打開姓名版選項以便看到正在演奏音樂的玩家的動畫並確認附近有\n誰可以聽到你。"
...
msg.OPTIONS_NAMEPLATES_OPTION_DISABLED_3RD_PARTY = "由于安装了铭牌定制插件，因此此选项无效。"
...
-- Module warnings
msg.ERR_INCOMPATIBLE_MODULE_API = "{module} 的 Musician 模塊無法啟動，因為 {module} 不兼容。嘗試更新 Musician 和 {module}。"
...
msg.TOOLTIP_COPY_URL = "按 {shortcut} 複製。"
...
msg.INSTRUMENT_NAMES["viola_da_gamba"] = "維奧爾琴（古大提琴）"
...
msg.INSTRUMENT_NAMES["war_horn"] = "戰爭號角"
...
msg.INSTRUMENT_NAMES["distortion_guitar"] = "變音電吉他"
msg.INSTRUMENT_NAMES["clean_guitar"] = "清音吉他"
msg.INSTRUMENT_NAMES["bass_guitar"] = "貝斯吉他"
msg.INSTRUMENT_NAMES["drumkit"] = "鼓組"
msg.INSTRUMENT_NAMES["war_drum"] = "戰鼓"
msg.INSTRUMENT_NAMES["woodblock"] = "木塊"
msg.INSTRUMENT_NAMES["tambourine_shake"] = "鈴鼓"
