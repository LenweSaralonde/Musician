...
msg.OPTIONS_AUDIO_CHANNELS_TITLE = "音频通道"
msg.OPTIONS_AUDIO_CHANNELS_HINT = "选择更多音频通道以增加 Musician 可以同时播放的最大音符数。"
msg.OPTIONS_AUDIO_CHANNELS_CHANNEL_POLYPHONY = "{channel} ({polyphony})"
msg.OPTIONS_AUDIO_CHANNELS_TOTAL_POLYPHONY = "最大复音总数：{polyphony}"
msg.OPTIONS_AUDIO_CHANNELS_AUTO_ADJUST_CONFIG = "选择多个音频通道时自动优化音频设置。"
...
msg.INSTRUMENT_NAMES["viola-da-gamba"] = "维奥尔琴（古大提琴）"
...
msg.INSTRUMENT_NAMES["war-horn"] = "战争号角"
