...
msg.OPTIONS_CATEGORY_NAME_PLATES = "Barres d'info des unités"
msg.OPTIONS_CATEGORY_NAME_PLATES_SUB_TEXT = "Voyez qui peut vous écouter d'un seul coup d'œil.\nAffiche une animation lorsque quelqu'un joue de la musique."
msg.OPTIONS_ENABLE_NAME_PLATES = "Activer les barres d'info des unités"
msg.OPTIONS_HIDE_HEALTH_BARS = "Masquer la barre de vie des unités amicales hors combat"
msg.OPTIONS_HIDE_NPC_NAME_PLATES = "Masquer les barres d'info des PNJs"
