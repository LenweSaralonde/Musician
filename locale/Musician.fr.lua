...
msg.COMMAND_MUTE = "Activer le mode silencieux"
msg.COMMAND_UNMUTE = "Désactiver le mode silencieux"
...
msg.OPTIONS_AUDIO_CACHE_SIZE_FOR_MUSICIAN = "Recommandé pour Musician (%d Mo)"
...
msg.OPTIONS_QUICK_PRELOADING_TITLE = "Préchargement rapide"
msg.OPTIONS_QUICK_PRELOADING_TEXT = "Activer le préchargement rapide des instruments au démarrage."
...
msg.OPTIONS_NAMEPLATES_OPTION_DISABLED_3RD_PARTY = "Cette option est sans effet car un add-on de personnalisation des barres d'info est installé."
...
-- Module warnings
msg.ERR_INCOMPATIBLE_MODULE_API = "Le module de Musician pour {module} n'a pas pu démarrer car {module} est incompatible. Essayez de mettre à jour Musician et {module}."
...
msg.MIDI_INSTRUMENT_NAMES[Instrument.Viola] = "Alto"
