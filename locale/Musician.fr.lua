...
msg.PLAY_IN_BAND_HINT = "Cliquez ici lorsque vous êtes prêt(e) à jouer avec votre groupe."
msg.PLAY_IN_BAND_READY_PLAYERS = "Joueurs prêts :"
msg.EMOTE_PLAYER_IS_READY = "est prêt(e) à jouer en groupe."
msg.EMOTE_PLAYER_IS_NOT_READY = "n'est plus prêt(e) à jouer en groupe."
msg.EMOTE_PLAY_IN_BAND_START = "a démarré le morceau de groupe."
msg.EMOTE_PLAY_IN_BAND_STOP = "a stoppé le morceau de groupe."

msg.LIVE_SYNC = "Mode groupe direct"
msg.LIVE_SYNC_HINT = "Cliquez ici pour jouer en direct avec votre groupe."
