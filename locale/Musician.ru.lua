...
msg.COMMAND_MUTE = "Отключить всю музыку"
msg.COMMAND_UNMUTE = "Включить музыку"
...
msg.OPTIONS_AUDIO_CACHE_SIZE_FOR_MUSICIAN = "Рекомендуется для Musician (%d МБ)"
...
msg.OPTIONS_QUICK_PRELOADING_TITLE = "Быстрая предварительная загрузка"
msg.OPTIONS_QUICK_PRELOADING_TEXT = "Включить быструю предварительную загрузку инструментов при холодном запуске."
...
msg.INSTRUMENT_NAMES["viola_da_gamba"] = "Виола да гамба"
...
msg.INSTRUMENT_NAMES["distortion_guitar"] = "Гитара искажения"
msg.INSTRUMENT_NAMES["clean_guitar"] = "Чистая гитара"
msg.INSTRUMENT_NAMES["bass_guitar"] = "Бас-гитара"
msg.INSTRUMENT_NAMES["drumkit"] = "Ударная установка"
msg.INSTRUMENT_NAMES["war_drum"] = "Барабан войны"
msg.INSTRUMENT_NAMES["woodblock"] = "Блок дерева"
msg.INSTRUMENT_NAMES["tambourine_shake"] = "Бубен (встряхнутый)"
