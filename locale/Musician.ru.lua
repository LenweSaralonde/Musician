...
msg.COMMAND_LIVE_KEYBOARD = "Открыть живую клавиатуру"
...
msg.ERR_CLASSIC_ON_RETAIL = "Вы используете ** классическую ** версию Musician в ** розничной ** версии WoW.\nПожалуйста, установите ** Розничную ** версию Musician."
msg.ERR_RETAIL_ON_CLASSIC = "Вы используете *** Retail ** версию Musician в ** Classic ** версии WoW.\nПожалуйста, установите ** Классическую ** версию Musician."
...
msg.EMOTE_PLAYER_IS_READY = "готов играть как группа."
msg.EMOTE_PLAYER_IS_NOT_READY = "больше не готов играть в группе."
msg.EMOTE_PLAY_IN_BAND_START = "начал играть в группе."
msg.EMOTE_PLAY_IN_BAND_STOP = "перестал играть оркестр."
...
msg.CONFIGURE_KEYBOARD_HINT_COMPLETE = "Настройка клавиатуры завершена.\nТеперь вы можете сохранить изменения и начать воспроизведение музыки!"
...
msg.ABOUT_SUPPORT = "Тебе нравится музыкант? Поделись со всеми!"
msg.ABOUT_PATREON = "Станьте покровителем: {url}"
msg.ABOUT_PAYPAL = "Пожертвовать: {url}"
msg.ABOUT_SUPPORTERS = "Отдельное спасибо сторонникам проекта <3"
...
msg.EMOTE_PROMO = "(Чтобы послушать, установите надстройку «Musician»)"
msg.EMOTE_SONG_NOT_LOADED = "(Песня не может воспроизводиться, потому что {player} использует несовместимую версию.)"
