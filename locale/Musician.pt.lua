...
msg.COMMAND_MUTE = "Silenciar todas as músicas"
msg.COMMAND_UNMUTE = "Música com som"
...
msg.OPTIONS_AUDIO_CACHE_SIZE_FOR_MUSICIAN = "Recomendado para Musician (%dMB)"
...
msg.OPTIONS_CATEGORY_NAMEPLATES_SUB_TEXT = "Habilite as placas de identificação para ver as animações nos personagens tocando\nmúsica e descubra quem pode ouvi-lo de relance."
...
msg.OPTIONS_HIDE_HEALTH_BARS = "Oculte as barras de saúde do jogador quando não estiver em combate."
...
msg.OPTIONS_NAMEPLATES_OPTION_DISABLED_3RD_PARTY = "Esta opção não tem qualquer efeito porque está instalado um add-on de personalização da placas de identificação."
...
-- Module warnings
msg.ERR_INCOMPATIBLE_MODULE_API = "Módulo Musician para {module} não pôde iniciar porque {module} é incompatível. Tente atualizar Musician e {module}."
