...
msg.STOP_TEST = "Stoppen Sie die Vorschau"
msg.CLEAR = "klar"
msg.SELECT_ALL = "Wählen Sie Alle"
msg.EDIT = "Bearbeiten"
msg.MUTE = "Stumm"
...
msg.MENU_IMPORT_SONG = "Importiere und spiele ein Lied"
msg.MENU_PLAY = "abspielen"
msg.MENU_STOP = "Halt"
msg.MENU_PLAY_PREVIEW = "Vorschau"
msg.MENU_STOP_PREVIEW = "Stoppen Sie die Vorschau"
msg.MENU_LIVE_PLAY = "Live spielen"
msg.MENU_SHOW_KEYBOARD = "Tastatur öffnen"
msg.MENU_SETTINGS = "die Einstellungen"
...
msg.COMMAND_PREVIEW_PLAY = "Starten oder Beenden der Vorschau des Songs"
msg.COMMAND_PREVIEW_STOP = "Stoppen Sie die Vorschau des Songs"
msg.COMMAND_PLAY = "Song abspielen oder stoppen"
msg.COMMAND_STOP = "Hör auf, ein Lied zu spielen"
msg.COMMAND_SONG_EDITOR = "Songeditor öffnen"
msg.COMMAND_LIVE_KEYBOARD = "Öffnen Sie die Live-Tastatur"
...
msg.ERR_CLASSIC_ON_RETAIL = "Sie verwenden die ** Classic ** -Version von Musician in der ** Retail ** -Version von WoW.\nBitte installieren Sie die ** Retail ** -Version von Musician."
msg.ERR_RETAIL_ON_CLASSIC = "Sie verwenden die *** Retail ** -Version von Musician für die ** Classic ** -Version von WoW.\nBitte installieren Sie die ** Classic ** -Version von Musician."

--- Add-on options
msg.OPTIONS_TITLE = "Musician"
msg.OPTIONS_SUB_TEXT = "Treten Sie dem Discord-Server bei, um Unterstützung zu erhalten! {url}"
msg.OPTIONS_CATEGORY_EMOTE = "Emote"
msg.OPTIONS_ENABLE_EMOTE_LABEL = "Senden Sie ein Textemote an Spieler, die beim Abspielen eines Songs keinen Musician haben."
msg.OPTIONS_ENABLE_EMOTE_PROMO_LABEL = "Fügen Sie einen kurzen Text hinzu, der sie zur Installation einlädt, damit sie die von Ihnen abgespielte Musik hören können."
msg.OPTIONS_EMOTE_HINT = "Ein Textemote wird den Spielern angezeigt, die keinen Musician haben, wenn Sie einen Song spielen. Sie können es in den [Optionen] deaktivieren."
msg.OPTIONS_INTEGRATION_OPTIONS_TITLE = "Integrationsoptionen im Spiel"
msg.OPTIONS_AUTO_MUTE_GAME_MUSIC_LABEL = "Schalten Sie die Musik im Spiel stumm, während ein Song abgespielt wird."
msg.OPTIONS_MUTE_INSTRUMENT_TOYS_LABEL = "Stumme Musik von Instrumentalspielzeug. {icons}"
msg.OPTIONS_CATEGORY_NAMEPLATES = "Typenschilder und Animationen"
msg.OPTIONS_CATEGORY_NAMEPLATES_SUB_TEXT = "Aktivieren Sie Typenschilder, um die Animationen von Musikfiguren anzuzeigen und herauszufinden, wer Sie auf einen Blick hören kann."
msg.OPTIONS_ENABLE_NAMEPLATES = "Aktivieren Sie Typenschilder und Animationen."
msg.OPTIONS_SHOW_NAMEPLATE_ICON = "Zeigen Sie ein {icon} -Symbol neben dem Namen der Spieler an, die auch Musician haben."
msg.OPTIONS_HIDE_HEALTH_BARS = "Verstecke die Gesundheitsbarren von Spielern und befreundeten Einheiten, wenn du nicht im Kampf bist."
msg.OPTIONS_HIDE_NPC_NAMEPLATES = "NPC-Typenschilder ausblenden."
msg.OPTIONS_CINEMATIC_MODE = "Zeigen Sie Animationen an, wenn die Benutzeroberfläche mit {binding} ausgeblendet ist."
msg.OPTIONS_CINEMATIC_MODE_NO_BINDING = "Zeigen Sie Animationen an, wenn die Benutzeroberfläche ausgeblendet ist."
msg.OPTIONS_NAMEPLATES_CINEMATIC_MODE = "Zeigen Sie Typenschilder an, wenn die Benutzeroberfläche ausgeblendet ist."
msg.OPTIONS_TRP3 = "Gesamt-RP 3"
msg.OPTIONS_TRP3_MAP_SCAN = "Zeigen Sie Spielern mit Musician auf der Karte einen Scan mit einem {icon} -Symbol an."
msg.OPTIONS_CROSS_RP_TITLE = "Cross RP"
msg.OPTIONS_CROSS_RP_SUB_TEXT = "Installieren Sie das Cross RP-Add-On von Tammya-MoonGuard, um fraktions- und bereichsübergreifende Musik zu aktivieren!"
msg.OPTIONS_CROSS_RP_SUB_TEXT_NO_GATEWAY = "Derzeit ist kein Cross-RP-Knoten verfügbar.\nBitte haben Sie etwas Geduld ..."
msg.OPTIONS_CROSS_RP_SUB_TEXT_ACTIVE = "Die RP-übergreifende Kommunikation ist für die folgenden Standorte aktiv:\n\n{bands}"

--- Tips and Tricks
msg.TIPS_AND_TRICKS_ENABLE = "Zeigen Sie Tipps und Tricks beim Start."

msg.TIPS_AND_TRICKS_NAMEPLATES_TITLE = "Animationen und Typenschilder"
msg.TIPS_AND_TRICKS_NAMEPLATES_TEXT = "Eine spezielle Animation ist für Charaktere sichtbar, die Musik abspielen, wenn die Typenschilder aktiviert sind.\n\nEin Symbol {icon} zeigt auch an, wer Musician hat und Sie hören kann.\n\nMöchten Sie jetzt Typenschilder und Animationen aktivieren?"
msg.TIPS_AND_TRICKS_NAMEPLATES_OK = "Aktivieren Sie Typenschilder und Animationen"
msg.TIPS_AND_TRICKS_NAMEPLATES_CANCEL = "Später"

msg.TIPS_AND_TRICKS_CROSS_RP_TITLE = "Fraktionsübergreifende Musik mit Cross RP"
msg.TIPS_AND_TRICKS_CROSS_RP_TEXT = "Installieren Sie das Cross RP-Add-On von Tammya-MoonGuard, um fraktions- und bereichsübergreifende Musik zu aktivieren!"
...
msg.PASTE_MUSIC_CODE = "Importieren Sie Ihren Song im MIDI-Format unter:\n{url}\n\nund fügen Sie dann den Musikcode hier ein ({shortcut})…"
msg.SONG_IMPORTED = "Geladenes Lied: {title}."

--- Play as a band
msg.PLAY_IN_BAND = "Spiele als Band"
msg.PLAY_IN_BAND_HINT = "Klicken Sie hier, wenn Sie bereit sind, dieses Lied mit Ihrer Band zu spielen."
msg.PLAY_IN_BAND_READY_PLAYERS = "Bereit Bandmitglieder:"
...
msg.LIVE_SYNC_HINT = "Klicken Sie hier, um die Bandsynchronisation zu aktivieren."
...
msg.GO_TO_START = "Geh um zu beginnen"
msg.GO_TO_END = "Geh zum Ende"
msg.SET_CROP_FROM = "Anfangspunkt setzen"
msg.SET_CROP_TO = "Endpunkt einstellen"
...
msg.SHOULD_CONFIGURE_KEYBOARD = "Sie müssen die Tastatur vor dem Spielen konfigurieren."
msg.CONFIGURE_KEYBOARD = "Tastatur konfigurieren"
msg.CONFIGURE_KEYBOARD_HINT = "Klicken Sie auf einen Schlüssel, um ..."
msg.CONFIGURE_KEYBOARD_HINT_COMPLETE = "Die Tastaturkonfiguration ist abgeschlossen.\nSie können jetzt Ihre Änderungen speichern und mit der Musikwiedergabe beginnen!"
msg.CONFIGURE_KEYBOARD_START_OVER = "Von vorn anfangen"
msg.CONFIGURE_KEYBOARD_SAVE = "Konfiguration speichern"
msg.PRESS_KEY_BINDING = "Drücken Sie die Taste # {col} in Zeile # {row}."
msg.KEY_CAN_BE_EMPTY = "Dieser Schlüssel ist optional und kann leer sein."
...
msg.KEY_CANNOT_BE_MERGED = "In diesem Fall ignorieren Sie es einfach und fahren mit dem nächsten Schlüssel fort."
msg.NEXT_KEY = "Nächster Schlüssel"
msg.CLEAR_KEY = "Schlüssel löschen"
...
msg.FIXED_KEY_NAMES[KEY.ShiftLeft] = "Verschiebung"
msg.FIXED_KEY_NAMES[KEY.ShiftRight] = "Verschiebung"
msg.FIXED_KEY_NAMES[KEY.ControlLeft] = "Strg"
msg.FIXED_KEY_NAMES[KEY.MetaLeft] = "Meta"
msg.FIXED_KEY_NAMES[KEY.AltLeft] = "Alt"
msg.FIXED_KEY_NAMES[KEY.Space] = "Platz"
msg.FIXED_KEY_NAMES[KEY.AltRight] = "Alt"
msg.FIXED_KEY_NAMES[KEY.MetaRight] = "Meta"
msg.FIXED_KEY_NAMES[KEY.ContextMenu] = "Speisekarte"
msg.FIXED_KEY_NAMES[KEY.ControlRight] = "Strg"
...
msg.KEYBOARD_LAYOUTS["Hawaiian"] = "hawaiisch"
...
msg.ENABLE_SOLO_MODE = "Aktivieren Sie den Solo-Modus (Sie spielen für sich selbst)"
msg.ENABLE_LIVE_MODE = "Aktivieren Sie den Live-Modus (Sie spielen für alle)"
...
msg.CHANGE_KEYBOARD_LAYOUT = "Ändern Sie das Tastaturlayout"
msg.BASE_KEY = "Basisschlüssel"
msg.CHANGE_BASE_KEY = "Basisschlüssel"
...
msg.LOAD_PROGRAM_NUM = "Laden Sie das Programm # {num} ({key})"
msg.SAVE_PROGRAM_NUM = "Speichern Sie im Programm # {num} ({key})"
msg.DELETE_PROGRAM_NUM = "Programm löschen # {num} ({key})"
msg.WRITE_PROGRAM = "Programm speichern ({key})"
...
msg.EMOTE_PROMO = "(Holen Sie sich das Add-On “Musician” zum Anhören)"
msg.EMOTE_SONG_NOT_LOADED = "(Das Lied kann nicht abgespielt werden, da {player} eine inkompatible Version verwendet.)"
msg.EMOTE_PLAYER_OTHER_REALM = "(Dieser Spieler befindet sich in einem anderen Reich.)"
...
msg.TOOLTIP_ACTION_OPEN_MENU = "Öffnen Sie das Hauptmenü"
...
msg.PLAYER_MENU_STOP_CURRENT_SONG = "Stoppen Sie das aktuelle Lied"
...
msg.LINK_EXPORT_WINDOW_HINT = "Der Link bleibt aktiv, bis Sie sich abmelden oder die Schnittstelle neu laden."
...
msg.LINK_IMPORT_WINDOW_HINT = "Klicken Sie auf “Importieren”, um den Import des Songs in Musician zu starten."
...
msg.LINK_IMPORT_WINDOW_SELECT_ACCOUNT = "Bitte wählen Sie den Charakter aus, von dem das Lied abgerufen werden soll:"

--- Song links errors
msg.LINKS_ERROR.notFound = "Das Lied “{title}” ist nicht bei {player} erhältlich."
msg.LINKS_ERROR.alreadySending = "Ein Song wird Ihnen bereits von {player} gesendet. Bitte versuchen Sie es in einigen Sekunden erneut."
...
msg.TRPE_ITEM_USE_HINT = "Lesen Sie die Noten"
msg.TRPE_ITEM_MUSICIAN_NOT_FOUND = "Sie müssen die neueste Version des Add-Ons “Musician” installieren, um dieses Element verwenden zu können.\nHolen Sie es von {url}"
msg.TRPE_ITEM_NOTES = "Importieren Sie das Lied in Musician, um es für die Spieler in der Nähe abzuspielen.\n\nMusician herunterladen: {url}\n"
...
msg.TRPE_EXPORT_WINDOW_ADD_TO_BAG = "Fügen Sie Ihrer Tasche hinzu"
msg.TRPE_EXPORT_WINDOW_QUANTITY = "Menge:"
msg.TRPE_EXPORT_WINDOW_HINT_NEW = "Erstellen Sie in Total RP ein Notenelement, das mit anderen Spielern gehandelt werden kann."
...
msg.INSTRUMENT_NAMES["dulcimer"] = "Hackbrett (gehämmert)"
...
msg.INSTRUMENT_NAMES["male-voice"] = "Männerstimme (Tenor)"
msg.INSTRUMENT_NAMES["female-voice"] = "Frauenstimme (Sopran)"
msg.INSTRUMENT_NAMES["trumpet"] = "Trompete"
msg.INSTRUMENT_NAMES["sackbut"] = "Posaune"
msg.INSTRUMENT_NAMES["war-horn"] = "Kriegshorn"
...
msg.INSTRUMENT_NAMES["distortion-guitar"] = "Verzerrungsgitarre"
msg.INSTRUMENT_NAMES["clean-guitar"] = "Saubere Gitarre"
msg.INSTRUMENT_NAMES["bass-guitar"] = "Bassgitarre"
msg.INSTRUMENT_NAMES["drumkit"] = "Schlagzeug"
msg.INSTRUMENT_NAMES["war-drum"] = "Kriegstrommel"
msg.INSTRUMENT_NAMES["woodblock"] = "Holzblock"
msg.INSTRUMENT_NAMES["tambourine-shake"] = "Tamburin (geschüttelt)"
...
msg.MIDI_INSTRUMENT_NAMES[Instrument.Guitarharmonics] = "Gitarrenoberwellen"
...
msg.MIDI_INSTRUMENT_NAMES[Instrument.ElectricBassPick] = "E-Bass (ausgewählt)"
...
msg.MIDI_INSTRUMENT_NAMES[Instrument.Pad7Halo] = "Pad 7 (Heiligenschein)"
