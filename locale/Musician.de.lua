...
msg.OPTIONS_AUDIO_CHANNELS_HINT = "Wählen Sie mehr Audiokanäle aus, um die maximale Anzahl von Noten zu erhöhen, die Musician gleichzeitig abspielen kann."
msg.OPTIONS_AUDIO_CHANNELS_CHANNEL_POLYPHONY = "{channel} ({polyphony})"
msg.OPTIONS_AUDIO_CHANNELS_TOTAL_POLYPHONY = "Maximale Gesamtpolyphonie: {polyphony}"
