...
Musician.Layouts.Piano = {
	...
	['upper'] = {
		['keyboardMapping'] = {
			...
			KEY.KeyI, KEY.Digit9, KEY.KeyO, KEY.Digit0, KEY.KeyP, KEY.Minus, KEY.BracketLeft, KEY.Equal, KEY.BracketRight, KEY.IntlYen, KEY.Backslash1
		},
		['baseKey'] = 'C4',
		['baseKeyIndex'] = 3,
	},
	['lower'] = {
		['keyboardMapping'] = {
			...
			KEY.Comma, KEY.KeyL, KEY.Period,  KEY.Semicolon, KEY.Slash, KEY.Quote, KEY.IntlRo, KEY.Backslash2,
		},
		['baseKey'] = 'C3',
		['baseKeyIndex'] = 2,
	},
